...
export function createLocalStorage(options?: { expire?: number | null; crypto?: boolean }) {
  ...
  const { expire, crypto = true } = Object.assign(
    {
...
export const ls = createLocalStorage({expire: null, crypto: false})

export const ss = createLocalStorage({ expire: 10800, crypto: true })
